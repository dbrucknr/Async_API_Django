...
class TaxiConsumer(AsyncJsonWebsocketConsumer):
    ...
    def _get_trip_ids(self, user):
        """
        Regardless of what group the user belongs to, they will be added to and removed from
    ...
    async def connect(self):
        """
        Automatically subscribe to the test group.
        Reject any connection that is not authorized by middleware.py
        """
    ...
    async def receive_json(self, content, **kwargs):
        ...
        Passing a type is a Channels convention that serves two purposes:
            1. Differentiate incoming messages. Informs the server how to process the data.
            2. Type maps directly to a consumer functions sent from another channel layer.
        """
    ...
    async def create_trip(self, message):
        # Creates a trip and passes data back to the client
    ...
    def _create_trip(self, data):
        # Performs the actual database create
